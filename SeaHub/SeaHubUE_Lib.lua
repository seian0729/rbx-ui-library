getgenv().UIColor = {
    ["Border Color"] = Color3.fromRGB(178, 178, 178),
    ...
    ["Search Icon"] = Color3.fromRGB(255, 255, 255),
    ["Search Icon Highlight"] = Color3.fromRGB(131, 181, 255),
...
local function Concac(color)
    return {math.floor(color.r*255),math.floor(color.g*255),math.floor(color.b*255)}
end

DefaultCustomConfig = {}

for i,v in next, getgenv().UIColor do
    if typeof(v) == 'Color3' then 
        DefaultCustomConfig[i] = Concac(v)
    else
        DefaultCustomConfig[i] = v
    end
end

local HttpService = game:GetService("HttpService")
local SaveCustomFileName = "CustomGUI.json"
 
if not isfolder('Sea Hub Premium') then
    makefolder('Sea Hub Premium')
end
if not pcall(function() readfile("Sea Hub Premium/" .. SaveCustomFileName) end) then
    writefile("Sea Hub Premium/" .. SaveCustomFileName, HttpService:JSONEncode(DefaultCustomConfig))
end
local SS
function CATS() 
    local ss, e = pcall(function() 
        SS = HttpService:JSONDecode(readfile("Sea Hub Premium/" .. SaveCustomFileName))    
    end)
    if not ss then 
        writefile("Sea Hub Premium/" .. SaveCustomFileName, HttpService:JSONEncode(DefaultCustomConfig))
        CATS() 
...
function SaveCustomSettings()
    writefile("Sea Hub Premium/" .. SaveCustomFileName, HttpService:JSONEncode(SS))
end
...
for i,v in next, SS do
    if typeof(v) == 'table' then 
        print(i,'=',v[1],v[2],v[3])
        getgenv().ASDefaults[i] = Color3.fromRGB(v[1],v[2],v[3])
        else
        getgenv().ASDefaults[i] = v
    end
end

for i, v in pairs(getgenv().ASDefaults) do
    warn(i, v)
end
...
for i, v in pairs(SS) do
    if string.find(v, ",") then
        local SSL = string.split(v, ",")
        getgenv().ASDefaults[i] = Color3.fromRGB(SSL[1], SSL[2], SSL[3])
    end
end
for i, v in pairs(getgenv().ASDefaults) do
    warn(i, v)
...
function Library_Function.CreateNoti(Setting)
    ...
    table.insert(getgenv().Occho, TextLabelNoti)
    ...
    CloseImage.ImageColor3 = getgenv().UIColor["Search Icon"]
	...
	if Desc then
        ...
        table.insert(getgenv().Occho, TextLabelNoti2)
    end
	...
	TextButton.MouseEnter:Connect(function()
		TweenService:Create(CloseImage, TweenInfo.new(.25),{ImageColor3 = getgenv().UIColor["Search Icon Highlight"]}):Play()
	end)

	TextButton.MouseLeave:Connect(function()
		TweenService:Create(CloseImage, TweenInfo.new(.25),{ImageColor3 = getgenv().UIColor["Search Icon"]}):Play()
	end)
...
function Library.CreateMain(Setting)
    ...
    table.insert(getgenv().Occho, Concacmain1)
    ...
    table.insert(getgenv().Occho, TextLabelMain)
    ...
    table.insert(getgenv().Occho, SettingIcon)
    ...
    table.insert(getgenv().Occho, PageControl)
    ...
    table.insert(getgenv().Occho, ControlTitle)
    ...
    function Library_Function.ReloadMain()
        ...
        local colorB = tostring(Library_Function.Getcolor(getgenv().UIColor['Title Text Color'])[3])
        local color = colorR .. ',' .. colorG .. ',' .. colorB
        TextLabel.Text = "<font color=\"rgb("..color..")\">Sea Hub Premium</font> " .. getgenv().MainDesc
    ...
    table.insert(getgenv().Occho, CustomTitle)
    ...
    CustomSearch.ClipsDescendants = true
    table.insert(getgenv().Occho, CustomSearch)
    ...
    SearchIcon.ImageColor3 = getgenv().UIColor["Search Icon"]
    table.insert(getgenv().Occho, SearchIcon)
    ...
    table.insert(getgenv().Occho, SearchBucu)
    

    local cummmed_ = false 

        active.MouseEnter:Connect(function()
            TweenService:Create(SearchIcon,TweenInfo.new(0.1),{ImageColor3 = getgenv().UIColor["Search Icon Highlight"]}):Play()
        end)

        active.MouseLeave:Connect(function()
            TweenService:Create(SearchIcon,TweenInfo.new(0.1),{ImageColor3 = getgenv().UIColor["Search Icon"]}):Play()
        end)
        ...
        function Setting_Function.CreateSection(Section_Name)
            ...
            local Setting_Section_Function = {}
                ...
                function Setting_Section_Function.CreateColorPicker(Setting,Callback)
                    ...
                    table.insert(getgenv().Occho, ColorPickBg)
                    ...
                    table.insert(getgenv().Occho, ColorpickTitle)
                    ...
                    table.insert(getgenv().Occho, cungroitext)
                    ...
                    table.insert(getgenv().Occho, hoithotext)
                    ...
                    Cor1.Name = "Cor1"
                    Cor1.Parent = Frame_2
                    Cor1.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                    ...
                    Cor2.Name = "Cor2"
                    Cor2.Parent = Frame_2
                    Cor2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                    ...
                    local function UpdateColor(concac)
                        ...
                        local Types = {}
                        if Type == "TextColor" then
                            Types = {
                                "TextColorPlaceholder",
                                "TextColor",
                                "Bindkey"
                            }
                        elseif Type == "TextColorPlaceholder" then
                            Types = {
                                "TextColorPlaceholder"
                            }
                        elseif Type == "GUITextColor" then
                            Types = {
                                "TextLabelNoti",
                                "TextLabelMain",
                                "GUITextColor"
                            }
                        elseif Type == "TitleTextColor" then
                            Types = {
                                "TextLabelNoti",
                                "TextLabelMain"
                            }
                        ...
                        if Type == "buttoneffect" then
                            getgenv().UIColor["Click Effect Color"] = NewColor
                        elseif Type then
                            for i, v in pairs(getgenv().Occho) do
                                if not v.Parent then
                                    table.remove(getgenv().Occho, i)
                                end
                                if typeof(v) ~= "table"
                                and Types
                                and table.find(Types, v.Name) then
                                    local ditmemaytvk
                                    if v:IsA("TextLabel")
                                    or v:IsA("TextBox")
                                    or v.Name == "Bindkey" then
                                        if v.Name == "TextColorPlaceholder"
                                        and Type == "TextColorPlaceholder" then
                                            ditmemaytvk = "PlaceholderColor3"
                                        else
                                    ...
                                    if Type == "TitleTextColor" then
                                        local colorR = tostring(Library_Function.Getcolor(NewColor)[1])
                                        local colorG = tostring(Library_Function.Getcolor(NewColor)[2])
                                        local colorB = tostring(Library_Function.Getcolor(NewColor)[3])
                                        local color = colorR .. ',' .. colorG .. ',' .. colorB
                                        if v.Name == "TextLabelMain" then
                                            v.Text = "<font color=\"rgb("..color..")\">Sea Hub Premium</font> " .. getgenv().MainDesc
                                        else
                                            v.Text = "<font color=\"rgb("..color..")\">Sea Hub Premium</font> " .. getgenv().TitleNameNoti
                                        end
                                    else
                    ...
                    Cungroitog.MouseButton1Click:Connect(function()
                        ...
                        print("Cungroi: "..tostring(_G.Cungroi))
                    end)
                    ...
                    Hoithoitog.MouseButton1Click:Connect(function()
                        ...
                        vanmeo = not vanmeo 
                       local csize = vanmeo and UDim2.new(1,-4,1,-4) or UDim2.new(0,0,0,0)
                       local pos = vanmeo and UDim2.new(.5,0,.5,0) or UDim2.new(0,0,1,0)
                       local apos = vanmeo and Vector2.new(.5,.5) or Vector2.new(0,1)
                    ...
                    ColorVal:GetPropertyChangedSignal('BackgroundColor3'):Connect(function()
                        Callback(ColorVal.BackgroundColor3)
                    end)
                ...
                function Setting_Section_Function.CreateBox(Setting,Callback)
                    ...
                    table.insert(getgenv().Occho, Boxxxx)
    ...
    function Main_Function.CreatePage(Setting)
        ...
        table.insert(getgenv().Occho, TabTitle)
        ...
        PageContainer.Name = "Background1"
        ...
        table.insert(getgenv().Occho, PageContainer)
        ...
        table.insert(getgenv().Occho, PageTitle)
        ...
        table.insert(getgenv().Occho, PageSearch)
        ...
        table.insert(getgenv().Occho, Bucu)
        ...
        PageButton.MouseButton1Click:Connect(function()
            ...
            if PageContainer.Name == "Background1" then 
                ...
                local Section_Function = {}
                   ...
                   function Section_Function.CreateToggle(Setting, Callback)
                    ...
                    function Section_Function.CreateDropdown(Setting, Callback)
                        ...
                        table.insert(getgenv().Occho, Dropdownbg)
						...
						local function refreshlist()
                            ...
                            if not Selected then 
								for i,v in pairs (ListNew) do
                                    ...
                                    table.insert(getgenv().Occho, Dropvalbutton)
                    ...
                    function Section_Function.CreateBind(Setting, Callback)
                        ...
                        table.insert(getgenv().Occho, BindButtonTitle)
                    ...
                    function Section_Function.CreateSlider(Setting, Callback)
                        ...
                        table.insert(getgenv().Occho, Sliderboxframe)
...
Section21.CreateDropdown({Title = 'Select which GPO mod u want to fuck most', List = {
    "memebot",
    "djt me may thang van dog dau buoi re rach",
    "Falcon",
    "joe biden"
    ...
    if v then
        Library_Function.CreateNoti({
            ...
            Desc = 'You decided to fuck ' .. tostring(v),
            ShowTime = 5,
        })
    end
end)
...
CCMain.CreateColorPicker({Title = "Border Color", Type = "maingui", Default = getgenv().ASDefaults["Border Color"]}, function(v)
    getgenv().UIColor["Border Color"] = v
end)
CCMain.CreateColorPicker({Title = "Click Effect Color", Type = "buttoneffect", Default = getgenv().ASDefaults["Click Effect Color"]}, function(v)
    getgenv().UIColor["Click Effect Color"] = v
end)
CCMain.CreateColorPicker({Title = "Setting Icon Color", Type = "SettingIcon", Default = getgenv().ASDefaults["Setting Icon Color"]}, function(v)
    getgenv().UIColor["Setting Icon Color"] = v
end)
CCMain.CreateBox({Title = 'Logo Image', Placeholder = 'URL Here (PNG only), Recommended 128x128', Number = false, Default = getgenv().ASDefaults["LogoImage"]}, function(x)
    getgenv().UIColor["Logo Image"] = v
    for i, v in pairs(getgenv().Occho) do
...
CCSearch.CreateColorPicker({Title = "Search Icon Color", Type = "SearchIcon", Default = getgenv().ASDefaults["Search Icon Color"]}, function(v)
    getgenv().UIColor["Search Icon"] = v
end)
CCSearch.CreateColorPicker({Title = "Search Icon Highlight Color", Type = nil, Default = getgenv().ASDefaults["Search Icon Highlight Color"]}, function(v)
    getgenv().UIColor["Search Icon Highlight"] = v
end)

local CCText = CustomColorUI.CreateSection("Text")
CCText.CreateColorPicker({Title = "GUI Text Color", Type = "GUITextColor", Default = getgenv().ASDefaults["GUI Text Color"]}, function(v)
    getgenv().UIColor["GUI Text Color"] = v
end)
CCText.CreateColorPicker({Title = "Text Color", Type = "TextColor", Default = getgenv().ASDefaults["Text Color"]}, function(v)
    getgenv().UIColor["Text Color"] = v
end)
CCText.CreateColorPicker({Title = "Placeholder Text Color", Type = "TextColorPlaceholder", Default = getgenv().ASDefaults["Placeholder Text Color"]}, function(v)
    getgenv().UIColor["Placeholder Text Color"] = v
end)
CCText.CreateColorPicker({Title = "Title Text Color", Type = "TitleTextColor", Default = getgenv().ASDefaults["Title Text Color"]}, function(v)
    getgenv().UIColor["Title Text Color"] = v
end)

local CCBackground = CustomColorUI.CreateSection("Background")
CCBackground.CreateColorPicker({Title = "Background 1 Color", Type = "Background1", Default = getgenv().ASDefaults["Background 1 Color"]}, function(v)
    getgenv().UIColor["Background 1 Color"] = v
end)
CCBackground.CreateColorPicker({Title = "Background 2 Color", Type = "Background2", Default = getgenv().ASDefaults["Background 2 Color"]}, function(v)
    getgenv().UIColor["Background 2 Color"] = v
end)

local CCSection = CustomColorUI.CreateSection("Section")
CCSection.CreateColorPicker({Title = "Section Text Color", Type = "Sectiontitle", Default = getgenv().ASDefaults["Section Text Color"]}, function(v)
    getgenv().UIColor["Section Text Color"] = v
end)
CCSection.CreateColorPicker({Title = "Section Underline Color", Type = "Linesec", Default = getgenv().ASDefaults["Section Underline Color"]}, function(v)
    getgenv().UIColor["Section Underline Color"] = v
end)
